...
{	global $_CENTRE;
	...
	{
		if(!$modname && isset($_CENTRE['allow_edit']))
	...
	else if(User('PROFILE')=='student')
	{
		...
		$_CENTRE['AllowEdit'] = DBGet(DBQuery("SELECT MODNAME FROM PROFILE_EXCEPTIONS WHERE PROFILE_ID='0' AND CAN_EDIT='Y'"),array(),array('MODNAME'));
