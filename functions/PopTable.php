	...
	if($action=='header')
	{
		echo "<CENTER>
			...
			if(is_array($title))
				...
				echo DrawTab($title);
			echo "</TD></TR>
			<TR><TD background=assets/left_shadow.gif width=4 height=100% rowspan=2>&nbsp;</TD><TD background=assets/bottom.gif height=7></TD><TD background=assets/right_shadow.gif width=4 height=100% rowspan=2></TD></TR><TR><TD bgcolor=white>";
