...
$fields_RET = DBGet(DBQuery("SELECT ID,TITLE,TYPE,SELECT_OPTIONS,DEFAULT_SELECTION,REQUIRED FROM CUSTOM_FIELDS WHERE CUSTOM_FIELDS.TABLE='students' AND CATEGORY_ID='$_REQUEST[category_id]' ORDER BY SORT_ORDER,TITLE"));
