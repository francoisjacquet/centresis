...
$header .= '<TD width=10></TD><TD>'.DrawTab(_('Students'),"Modules.php?modname=$_REQUEST[modname]&day_start=$_REQUEST[day_start]&month_start=$_REQUEST[month_start]&year_start=$_REQUEST[year_start]&day_end=$_REQUEST[day_end]&month_end=$_REQUEST[month_end]&year_end=$_REQUEST[year_end]&type=student",$tabcolor_s,$textcolor_s,'_circle',array('tabcolor'=>Preferences('HEADER'),'textcolor'=>'#FFFFFF')).'</TD>';
$header .= '<TD width=10></TD><TD>'.DrawTab(_('Users'),   "Modules.php?modname=$_REQUEST[modname]&day_start=$_REQUEST[day_start]&month_start=$_REQUEST[month_start]&year_start=$_REQUEST[year_start]&day_end=$_REQUEST[day_end]&month_end=$_REQUEST[month_end]&year_end=$_REQUEST[year_end]&type=staff",  $tabcolor_u,$textcolor_u,'_circle',array('tabcolor'=>Preferences('HEADER'),'textcolor'=>'#FFFFFF')).'</TD>';
$header .= '<TD width=10></TD></TR></TABLE>';

DrawHeader(($_REQUEST['type']=='staff'?_('User'):_('Student')).ProgramTitle(),(User('PROFILE')=='student'?'':'<TABLE bgcolor=#ffffff><TR><TD>'.$header.'</TD></TR></TABLE>'));
...
$type_select = 'Type<SELECT name=type_select><OPTION value=\'\'>'._('Not Specified').'</OPTION>';
