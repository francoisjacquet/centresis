...
if($date != DBDate())
	$date_note = ' <FONT color=red>'._('The selected date is not today').'</FONT>';
...
$LO_columns = array('FULL_NAME'=>_('Student'),'STUDENT_ID'=>_('Centre ID'),'GRADE_ID'=>_('Grade'),'BALANCE'=>_('Balance'),'STATUS'=>_('Status'));
