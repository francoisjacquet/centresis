...
$header .= '<TD width=10></TD><TD>'.DrawTab(_('Students'),"Modules.php?modname=$_REQUEST[modname]&modfunc=select&menu_id=$_REQUEST[menu_id]&fsa_type=student",$tabcolor_s,$textcolor_s,'_circle',array('tabcolor'=>Preferences('HEADER'),'textcolor'=>'#FFFFFF')).'</TD>';
$header .= '<TD width=10></TD><TD>'.DrawTab(_('Users'),   "Modules.php?modname=$_REQUEST[modname]&modfunc=select&menu_id=$_REQUEST[menu_id]&fsa_type=staff",  $tabcolor_u,$textcolor_u,'_circle',array('tabcolor'=>Preferences('HEADER'),'textcolor'=>'#FFFFFF')).'</TD>';
