...
echo '<small>'._('We would appreciate it if you would enter just a little bit of information about you and your child to help us out this school year. Thanks!').'</small>';
if($addresses[1]['COUNT']!=0)
	echo '<BR><BR><IMG SRC=assets/check.gif><b>'._('Your child has been registered.').'</b>';
...
echo '</TD></TR></TABLE>';
echo '</TD><TD>';
echo '<B>'.Localize('colon',_('Information about your spouse or significant other residing with you')).'</B><BR><small>'._('Leave this section blank if you are separated.').'</small>';
...
$language_options = array('English'=>_('English'),
                            ...
                            'Zulu'=>'Zulu',
                            'Zuni'=>'Zuni');
echo SelectInput($student['CUSTOM_200000005'],'values[STUDENTS][CUSTOM_200000005]',_('Language'),$language_options,'N/A','style="width:200"');
echo '</TD>';
echo '</TR>';
...
echo '</TD>';
echo '<TD>';
echo _makeInput('values[STUDENTS][CUSTOM_200000002]',_('Hebrew Name'));
echo '</TD>';
echo '</TR>';
